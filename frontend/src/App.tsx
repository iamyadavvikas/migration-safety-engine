      ...
      <div className="app">
        <nav className="nav">
          ...
          <div className="nav-right">
            <a href="https://github.com/iamyadavvikas/migration-safety-engine" target="_blank" rel="noopener noreferrer" className="nav-github">
        ...
        <footer className="footer">
          <span>Migration Safety Engine — SLO-gated canary migrations for Postgres</span>
          <span>Built with Go + React + D3.js</span>
        </footer>
      </div>
    </BrowserRouter>
  )
